...
static void dijkstra_shortest_path(dungeon_t *d)
{
  static corridor_path_t path[DUNGEON_Y][DUNGEON_X], *p;
  static uint32_t initialized = 0;
  heap_t h;
...
static void dijkstra_shortest_path_tunneling(dungeon_t *d)
{
  static corridor_path_t path[DUNGEON_Y][DUNGEON_X], *p;
  static uint32_t initialized = 0;
  heap_t h;
  ...
  // for (y = 0; y < DUNGEON_Y; y++) {
  //   for (x = 0; x < DUNGEON_X; x++) {
  //       printf("%02x", d->hardness[y][x]);  // Print with formatting
  //   }
  //   printf("\n");
  // }
  ...
  // for (y = 0; y < DUNGEON_Y; y++) {
  //   for (x = 0; x < DUNGEON_X; x++) {
  //       printf("%d", 1 + (d->hardness[y][x] / 85));  // Print with formatting
  //   }
  //   printf("\n");
  // }
...
int main(int argc, char *argv[])
{
  ...
  printf("\n\n");
  dijkstra_shortest_path_tunneling(&d);
