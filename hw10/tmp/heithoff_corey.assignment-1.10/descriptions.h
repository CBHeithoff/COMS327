...
class monster_description {
 private:
  ...
  inline bool is_monster_boss()
  {
    return abilities & NPC_BOSS;
  }
  inline bool is_high_diff_monster()
  {
    return hitpoints.get_base() >= 100000 || damage.get_base() >= 25;
  }
  inline bool is_fast_monster()
  {
    return speed.get_base() >= 30;
  }
...
class object_description {
 ...
 public:
  ...
  inline bool is_weapon_shop()
  {
    return type == objtype_WEAPON || 
           type == objtype_OFFHAND || 
           type == objtype_RANGED;
  }
  inline bool is_armor_shop()
  {
    return type == objtype_ARMOR || 
           type == objtype_HELMET || 
           type == objtype_CLOAK ||
           type == objtype_GLOVES ||
           type == objtype_BOOTS;
  }
  inline bool is_misc_shop()
  {
    return type == objtype_RING ||
           type == objtype_AMULET || 
           type == objtype_LIGHT;
  }
  inline bool pass_rarity_roll()
