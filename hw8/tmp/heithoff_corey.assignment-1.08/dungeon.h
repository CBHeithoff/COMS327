...
class dungeon {
 public:
  ...
  std::vector<int> unique_monsters;
  void init_unique_monsters(size_t count) {
    unique_monsters.assign(count, 0);
  }
  std::vector<int> artifact_objects;
  void init_artifact_monsters(size_t count) {
    artifact_objects.assign(count, 0);
  }
};
