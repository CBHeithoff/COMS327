...
object* create_object(object_description o_desc) {
  return new object(o_desc.get_name(), o_desc.get_type(), o_desc.get_color(), o_desc.get_damage(),
                    o_desc.get_hit().roll(), o_desc.get_dodge().roll(), o_desc.get_defence().roll(), 
                    o_desc.get_weight().roll(), o_desc.get_speed().roll(), o_desc.get_attribute().roll(), o_desc.get_value().roll());
}
